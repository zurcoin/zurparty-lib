        ...
        if block_index <= block_count:
            ...
            with db:
                ...
                for tx_hash in txhash_list:
                    ...
                    if tx_hex is None: # addrindex must contain all txes mined in a block...
                        raise Exception("txhash {} (mined in block hash {}) not in addrindex raw transactions cache.".format(tx_hash, block_hash))
